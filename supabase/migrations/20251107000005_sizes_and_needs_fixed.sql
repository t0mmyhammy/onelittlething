...
DROP TRIGGER IF EXISTS update_child_sizes_timestamp ON child_sizes;
...
DROP POLICY IF EXISTS "Users can view sizes for their family's children" ON child_sizes;
DROP POLICY IF EXISTS "Users can insert sizes for their family's children" ON child_sizes;
DROP POLICY IF EXISTS "Users can update sizes for their family's children" ON child_sizes;
DROP POLICY IF EXISTS "Users can delete sizes for their family's children" ON child_sizes;

DROP POLICY IF EXISTS "Users can view shopping items for their family" ON shopping_list_items;
DROP POLICY IF EXISTS "Users can insert shopping items for their family" ON shopping_list_items;
DROP POLICY IF EXISTS "Users can update shopping items for their family" ON shopping_list_items;
DROP POLICY IF EXISTS "Users can delete shopping items for their family" ON shopping_list_items;
